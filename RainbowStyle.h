...
class CRainbowStyle : public CMFCVisualManagerOffice2007
{
    DECLARE_DYNCREATE(CRainbowStyle);
...
public:
        ...
        CRect rectButtons)
    {
        ...
        CBrush brush(RGB(0x58,0x8c,0x36));
        ...
        BOOL bIsSelected)
    {
        ...
        pDC->FillSolidRect(rect, RGB(0x9a,0xe3,0x72));
        return RGB(0x9a,0xa3,0x28);
    }
        ...
        CRect rectCategory)
    {
        ...
        pDC->FillSolidRect(rectCategory, RGB(0x79,0x16,0x9b));

        CPen pen(PS_SOLID, 1, RGB(0xf5,0xa7,0x45));
        ...
        CMFCRibbonButton* pButton)
    {
        ...
        if (!text.IsEmpty()) {
            pDC->FillSolidRect(pButton->GetRect(), RGB(0x39,0x8a,0xca));
            return RGB(0xdb, 0xcf, 0x1f);
        }
        return RGB(0x4e,0x03,0xb2);
    }
    ...
    )
    {
        ...
        pDC->FillSolidRect(rect, RGB(0x7f,0xa0,0xbe));
    }
        ...
        CRect rect)
    {
        ...
        pDC->FillSolidRect(pPanel->GetRect(), RGB(0x6d,0xa5,0x45));
    }
    ...
    {
        static_cast<void>(pPanel);
        pDC->FillSolidRect(rect, RGB(0x1a,0x14,0x45));
    }
        ...
        if (pButton->GetParentPanel() && pButton->GetParentPanel()->IsKindOf(RUNTIME_CLASS(CMFCRibbonMainPanel)))
        {
            ...
            if (pButton->IsLargeImage()) {
                if (pButton->IsHighlighted()) {
                    // #EDF4FC
                    pDC->FillSolidRect(pButton->GetRect(), RGB(0x85,0xeb,0xc0));

                    // #A8D2FD
                    CPen pen(PS_SOLID, 1, RGB(0xad,0x2a,0xb5));
                    pDC->SelectObject(pen);
                    pDC->SelectStockObject(NULL_BRUSH);
                    pDC->Rectangle(pButton->GetRect());
                }
                else {
                    pDC->FillSolidRect(pButton->GetRect(), RGB(0x93,0xd3,0x24));
                }
                return RGB(0x37, 0xe4, 0x0c);
            }
        }
        return RGB(0x08, 0x01, 0x46);
    }
    ...
    virtual COLORREF OnDrawMenuLabel(
        ...
        CRect rect)
    {
        pDC->FillSolidRect(rect, RGB(0x4b,0xeb,0xf2));
        return RGB(0xf0,0xe6,0xb8);
    }
        ...
        BOOL bIsActive)
    {
        ...
        if (bIsActive) {
            pDC->FillSolidRect(pTab->GetRect(), RGB(0x0c,0xf9,0xd5));
            ...
            CPen pen2(PS_SOLID, 1, RGB(0xfa,0x6e,0xa3));
            pDC->SelectObject(pen2);
            pDC->LineTo(CPoint(pTab->GetRect().left, pTab->GetRect().bottom));
        }
        else {
            CBrush brush(RGB(0x79,0xbb,0xf6));
        ...
        CRect rectCaption)
    {
        ...
        pDC->FillSolidRect(rectPanel, RGB(0xb6,0x16,0x9e));
    ...
    virtual void OnDrawRibbonPanelCaption(
        ...
        CRect rectCaption)
    {
        pDC->FillSolidRect(rectCaption, RGB(0xc9,0xa4,0x88));
        ...
        CRect rectTab)
    {
        ...
        CBrush brush(RGB(0x28,0xcd,0xb3));
        ...
        CMFCRibbonStatusBarPane* pPane)
    {
        ...
        CBrush brush(RGB(0x45,0x5f,0x59));
        ...
        BOOL bNCArea = FALSE)
    {
        ...
        static_cast<void>(pBar);
        CBrush brush(RGB(0xff,0x0e,0x36));
        ...
        const CMFCBaseTabCtrl* pTabWnd)
    {
        ...
        CBrush brush(RGB(0x98,0x72,0xd0));
        ...
        CRect rectSizeBox)
    {
        ...
        CBrush brush(RGB(0xef,0x3e,0xe4));
    ...
    {
        if (bIsActive) {
            pDC->FillSolidRect(rectTab, RGB(0x66,0x17,0xfc));
        }
        else {
            pDC->FillSolidRect(rectTab, RGB(0xb4,0x86,0xf8));
        }
        ...
        const CMFCBaseTabCtrl* pTabWnd)
    {
        ...
        CBrush brush(RGB(0x9e,0x13,0x2c));
        ...
        BOOL bIsActive)
    {
        ...
        static_cast<void>(pTabWnd);
        static_cast<void>(bIsActive);
        return RGB(0x8f,0x42,0xc7);
    }

    virtual COLORREF GetPropertyGridGroupColor(CMFCPropertyGridCtrl* pPropList)
    {
        static_cast<void>(pPropList);
        return RGB(0x68,0x54,0x1c);
    }
    ...
    {
        static_cast<void>(pTabWnd);
        pDC->FillSolidRect(rect, RGB(0xf,0x0f,0xd87));
    }
    ...
    void OnUpdateSystemColors() override
    {
        ...
        GetGlobalData()->clrBarWindow = RGB(0x85, 0x6e, 0x42);
        GetGlobalData()->clrWindow = RGB(0x85, 0x6e, 0x42);
